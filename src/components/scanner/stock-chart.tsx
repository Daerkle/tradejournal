  ...
  return (
    <div className="relative">
      <div className="absolute top-2 left-2 z-10 flex gap-2 text-xs">
        <span className="px-1.5 py-0.5 rounded bg-cyan-500/20 text-cyan-500">EMA 10</span>
        <span className="px-1.5 py-0.5 rounded bg-yellow-500/20 text-yellow-500">EMA 20</span>
        <span className="px-1.5 py-0.5 rounded bg-purple-500/20 text-purple-500">EMA 50</span>
        <span className="px-1.5 py-0.5 rounded bg-red-500/20 text-red-500">EMA 200</span>
      </div>
